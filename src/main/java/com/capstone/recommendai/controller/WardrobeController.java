...
public class WardrobeController {
    ...
    public ResponseEntity<WardrobeItemResponse> uploadItem(
        ...
        // ========================================================
        // Gemini Vision으로 옷 이미지 분석
        // ========================================================

        Map analyzed =
                aiService.analyzeImage(imageB64);
    ...
    private String convertStyleTagsToString(
            Object styleTags) {
        ...
        if (!(styleTags instanceof List<?> list)) {
    ...
    public ResponseEntity<?> recommend(
        ...
        List<WardrobeItemResponse> itemResponses =
                wardrobeRepository
                        .findByUser(user)
                        .stream()
                        .map(
                                WardrobeItemResponse::new
                        )
                        .collect(
                                Collectors.toList()
                        );
